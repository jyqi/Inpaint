...
end_frame       = 2000;
channel = 'ch_1';
img_min = imread(['../video_' num2str(seq_num) '/' channel '/vd_' num2str(seq_num) '_' num2str(start_frame) '.bmp']);
img_max = imread(['../video_' num2str(seq_num) '/' channel '/vd_' num2str(seq_num) '_' num2str(start_frame) '.bmp']);
