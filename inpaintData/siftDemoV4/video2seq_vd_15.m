clc;clear;
tic;
% firstObj    = VideoReader(['../video_15/vd_15.mp4']);
...
% for i = start_frame:frame_interval:end_frame
%     img_name = ['/vd_' num2str(seq_num) '_' num2str(i)];
%     img = imread(['../video_' num2str(seq_num) '/' img_name '.png']);
% 
...
img1 = ['../video_' num2str(seq_num) '/ch_1/vd_' num2str(seq_num) '_' num2str(start_frame) '.bmp'];
[im1, des1, loc1] = sift(img1);

for i = start_frame+frame_interval:frame_interval:end_frame
    img2 = ['../video_' num2str(seq_num) '/ch_1/vd_' num2str(seq_num) '_' num2str(start_frame) '.bmp'];
