...
seq_num         = 9;
frame_interval  = 4;
start_frame     = 82;     %82;   %124
end_frame       = 140;     %140;  %140
...
%% 加入inpainting前景
% mask        = double(imread(['../video_' num2str(seq_num) '/other/decrypt_mask.png']));
% org_frame   = double(imread(['../video_' num2str(seq_num) '/rgb/_vd_9_118_bak.png']));
% 
% rand_idx = rand(150, 150, 3)./2;
% org_frame(101:250, 221:370, :)   = org_frame(101:250, 221:370, :).*rand_idx + mask(101:250, 221:370, :).*(ones(150, 150, 3) - rand_idx);
% imwrite(uint8(org_frame), ['../video_' num2str(seq_num) '/rgb/vd_9_118.png']);
